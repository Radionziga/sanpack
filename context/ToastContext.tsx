        ...
        <AnimatePresence>
          {toasts.map((toast) => (
            <motion.div
              ...
              className="pointer-events-auto bg-[#18231E]/95 backdrop-blur-xl text-white p-3.5 rounded-2xl shadow-2xl border border-white/10 flex items-start justify-between gap-3 font-sans"
            >
              <div className="flex items-start gap-3">
                <div className="p-2 rounded-xl bg-[#006F3C] text-white shrink-0 mt-0.5">
                  {toast.type === 'success' ? (
