...
- Search не индексирует attributes. Product/Variant SKU, localized Product/Variant names и Category names поддерживаются; совпавший Variant подписывается в выдаче, но пока не выбирается автоматически после перехода на detail page.
