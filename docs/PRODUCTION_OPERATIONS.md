...
- GA4 property **stamply-4df8a** (`514533266`) in the owner account `hello@clarityext.com`, web stream **Sanpack** (`15319853813`), Measurement ID `G-ZXR9E6443E`. Enhanced Measurement stays off because the application owns SPA page-view mapping. `request_created` maps to `generate_lead`, never `purchase`.
