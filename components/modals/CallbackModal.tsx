...
export function CallbackModal({ isOpen, onClose }: CallbackModalProps) {
  ...
  const copy = {
    ru: {
      ...
      successText: 'Менеджер магазина перезвонит вам в ближайшее время.',
      team: 'Отдел продаж',
    ...
    uz: {
      ...
      successText: 'Do‘kon menejeri tez orada sizga qo‘ng‘iroq qiladi.',
      team: 'Savdo bo‘limi',
    ...
    en: {
      ...
      successText: 'A store manager will call you shortly.',
      team: 'Sales team',
