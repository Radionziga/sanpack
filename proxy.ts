...
function localizedCatalogNotFound(request: NextRequest, locale: string) {
  const copy = {
    ru: ['Ошибка 404', 'Такой страницы нет', 'Проверьте адрес или продолжите поиск в каталоге.', 'Перейти в каталог'],
    uz: ['404 xatosi', 'Bu sahifa topilmadi', 'Manzilni tekshiring yoki katalogda qidirishni davom ettiring.', 'Katalogga o‘tish'],
    en: ['Error 404', 'This page could not be found', 'Check the address or continue browsing the catalog.', 'Browse catalog'],
    zh: ['404 错误', '未找到此页面', '请检查地址，或继续浏览商品目录。', '浏览目录'],
  } as const;
