...
export const priceList2026Categories: Category[] = [
  { id: 'cat-packaging', slug: 'upakovka', titleRu: 'Упаковка и расходные материалы', titleUz: 'Qadoqlash va sarf materiallari', titleEn: 'Packaging and consumables', image: '/catalog/categories/packaging_hero.png', navigationImage: '/catalog/category-icons-v3/packaging.webp', icon: 'Package', status: 'active', sortOrder: 1 },
  { id: 'cat-trash-bags', parentId: 'cat-packaging', slug: 'musornye-pakety', titleRu: 'Мусорные пакеты', titleUz: 'Chiqindi paketlari', titleEn: 'Refuse bags', image: '/catalog/categories/trash_bags.png', navigationImage: '/catalog/category-icons-v3/trash-bags.webp', cardImage: '/catalog/popular-categories/trash-bags-20260823.webp', featured: true, featuredSortOrder: 10, icon: 'Trash2', status: 'active', sortOrder: 10 },
  { id: 'cat-tearoff-bags', parentId: 'cat-packaging', slug: 'otryvnye-pakety', titleRu: 'Отрывные пакеты', titleUz: 'Uziladigan paketlar', titleEn: 'Perforated bags', image: '/catalog/categories/tearoff_bags.png', navigationImage: '/catalog/category-icons-v3/tearoff-bags.webp', cardImage: '/catalog/popular-categories/tearoff-bags-20260828.webp', featured: true, featuredSortOrder: 11, icon: 'Layers', status: 'active', sortOrder: 11 },
  { id: 'cat-carrier-bags', parentId: 'cat-packaging', slug: 'pakety-mayka', titleRu: 'Пакеты «Майка»', titleUz: 'Mayka paketlar', titleEn: 'T-shirt carrier bags', image: '/catalog/categories/carrier_bags.png', navigationImage: '/catalog/category-icons-v3/carrier-bags.webp', cardImage: '/catalog/popular-categories/carrier-bags-20260828.webp', featured: true, featuredSortOrder: 12, icon: 'ShoppingBag', status: 'active', sortOrder: 12 },
  { id: 'cat-special-bags', parentId: 'cat-packaging', slug: 'vakuumnye-i-pizza-pakety', titleRu: 'Вакуумные пакеты и пакеты для пиццы', titleUz: 'Vakuum va pitsa paketlari', titleEn: 'Vacuum and pizza bags', image: '/catalog/categories/vacuum_pizza_bags.png', navigationImage: '/catalog/category-icons-v3/special-bags.webp', cardImage: '/catalog/popular-categories/special-bags-20260828.webp', featured: true, featuredSortOrder: 13, icon: 'PackageOpen', status: 'active', sortOrder: 13 },
  { id: 'cat-food-packaging', parentId: 'cat-packaging', slug: 'upakovka-dlya-produktov', titleRu: 'Упаковка для пищевых продуктов', titleUz: 'Oziq-ovqat qadoqlari', titleEn: 'Food packaging', image: '/catalog/categories/food_packaging.png', navigationImage: '/catalog/category-icons-v3/food-packaging.webp', cardImage: '/catalog/popular-categories/food-packaging-20260828.webp', featured: true, featuredSortOrder: 14, icon: 'Film', status: 'active', sortOrder: 14 },
  { id: 'cat-gloves', parentId: 'cat-packaging', slug: 'perchatki', titleRu: 'Перчатки', titleUz: 'Qo‘lqoplar', titleEn: 'Gloves', image: '/catalog/categories/gloves.png', navigationImage: '/catalog/category-icons-v3/gloves.webp', cardImage: '/catalog/popular-categories/gloves-20260828.webp', featured: true, featuredSortOrder: 15, icon: 'Hand', status: 'active', sortOrder: 15 },
  { id: 'cat-cleaning', parentId: 'cat-packaging', slug: 'khoztovary', titleRu: 'Хозяйственные товары', titleUz: 'Xo‘jalik mollari', titleEn: 'Cleaning supplies', image: '/catalog/categories/cleaning.png', icon: 'Sparkles', status: 'active', sortOrder: 16 },
  { id: 'cat-paper-goods', parentId: 'cat-packaging', slug: 'bumazhnaya-produktsiya', titleRu: 'Бумажная продукция', titleUz: 'Qog‘oz mahsulotlari', titleEn: 'Paper products', image: '/catalog/extracted_p10_img1.jpeg', icon: 'ScrollText', status: 'active', sortOrder: 17 },

  { id: 'cat-food', slug: 'produkty-pitaniya', titleRu: 'Продукты питания', titleUz: 'Oziq-ovqat mahsulotlari', titleEn: 'Food products', image: '/catalog/categories/food_hero.png', navigationImage: '/catalog/category-icons-v3/food.webp', icon: 'Utensils', status: 'active', sortOrder: 2 },
  { id: 'cat-beef', parentId: 'cat-food', slug: 'govyadina', titleRu: 'Говядина', titleUz: 'Mol go‘shti', titleEn: 'Beef', image: '/catalog/categories/beef.png', navigationImage: '/catalog/category-icons-v3/beef.webp', cardImage: '/catalog/popular-categories/beef-20260828.webp', featured: true, featuredSortOrder: 20, icon: 'Beef', status: 'active', sortOrder: 20 },
  { id: 'cat-chicken', parentId: 'cat-food', slug: 'kuritsa', titleRu: 'Курица', titleUz: 'Tovuq go‘shti', titleEn: 'Chicken', image: '/catalog/categories/chicken.png', navigationImage: '/catalog/category-icons-v3/chicken.webp', cardImage: '/catalog/popular-categories/chicken-20260828.webp', featured: true, featuredSortOrder: 21, icon: 'Drumstick', status: 'active', sortOrder: 21 },
  { id: 'cat-eggs', parentId: 'cat-food', slug: 'yaytsa', titleRu: 'Куриные яйца', titleUz: 'Tovuq tuxumlari', titleEn: 'Chicken eggs', image: '/catalog/categories/eggs.png', icon: 'Egg', status: 'active', sortOrder: 22 },
  { id: 'cat-flour', parentId: 'cat-food', slug: 'muka', titleRu: 'Мука', titleUz: 'Un', titleEn: 'Flour', image: '/catalog/categories/flour.png', icon: 'Wheat', status: 'active', sortOrder: 23 },
  { id: 'cat-sugar', parentId: 'cat-food', slug: 'sakhar', titleRu: 'Сахар', titleUz: 'Shakar', titleEn: 'Sugar', image: '/catalog/categories/sugar.png', icon: 'Box', status: 'active', sortOrder: 24 },
  { id: 'cat-groats', parentId: 'cat-food', slug: 'krupy-i-bobovye', titleRu: 'Крупы и бобовые', titleUz: 'Yorma va dukkaklilar', titleEn: 'Grains and pulses', image: '/catalog/categories/groats.png', navigationImage: '/catalog/category-icons-v3/groats.webp', cardImage: '/catalog/popular-categories/groats-20260828.webp', featured: true, featuredSortOrder: 25, icon: 'Wheat', status: 'active', sortOrder: 25 },
  { id: 'cat-oils', parentId: 'cat-food', slug: 'rastitelnye-masla', titleRu: 'Растительные и фритюрные масла', titleUz: 'O‘simlik va fritür moylari', titleEn: 'Cooking and frying oils', image: '/catalog/categories/oils.png', icon: 'Bottle', status: 'active', sortOrder: 26 },
  { id: 'cat-fruits', parentId: 'cat-food', slug: 'frukty', titleRu: 'Фрукты', titleUz: 'Mevalar', titleEn: 'Fruit', image: '/catalog/categories/fruits.png', navigationImage: '/catalog/category-icons-v3/fruits.webp', cardImage: '/catalog/popular-categories/fruits-20260828.webp', featured: true, featuredSortOrder: 27, icon: 'Apple', status: 'active', sortOrder: 27 },
  { id: 'cat-berries', parentId: 'cat-food', slug: 'yagody', titleRu: 'Ягоды', titleUz: 'Rezavorlar', titleEn: 'Berries', image: '/catalog/categories/berries.png', icon: 'Cherry', status: 'active', sortOrder: 28 },
  { id: 'cat-vegetables', parentId: 'cat-food', slug: 'ovoshchi', titleRu: 'Овощи', titleUz: 'Sabzavotlar', titleEn: 'Vegetables', image: '/catalog/categories/vegetables.png', navigationImage: '/catalog/category-icons-v3/vegetables.webp', cardImage: '/catalog/popular-categories/vegetables-20260828.webp', featured: true, featuredSortOrder: 29, icon: 'Carrot', status: 'active', sortOrder: 29 },
  { id: 'cat-greens', parentId: 'cat-food', slug: 'svezhaya-zelen', titleRu: 'Свежая зелень Novagreen', titleUz: 'Novagreen yangi ko‘katlari', titleEn: 'Fresh Novagreen greens', image: '/catalog/categories/fresh_greens.png', navigationImage: '/catalog/category-icons-v3/greens.webp', cardImage: '/catalog/popular-categories/greens-20260828.webp', featured: true, featuredSortOrder: 30, icon: 'Leaf', status: 'active', sortOrder: 30 },
  { id: 'cat-microgreens', parentId: 'cat-food', slug: 'mikrozelen', titleRu: 'Микрозелень', titleUz: 'Mikroko‘katlar', titleEn: 'Microgreens', image: '/catalog/categories/microgreens.png', icon: 'Sprout', status: 'active', sortOrder: 31 },
  { id: 'cat-dairy', parentId: 'cat-food', slug: 'molochnaya-produktsiya', titleRu: 'Молочная продукция', titleUz: 'Sut mahsulotlari', titleEn: 'Dairy products', image: '/catalog/categories/dairy.png', icon: 'Milk', status: 'active', sortOrder: 32 },
];
...
export const priceList2026Attributes: Attribute[] = [
  ...
  { id: 'attr-fat', key: 'fat', titleRu: 'Жирность', titleUz: 'Yog‘lilik', titleEn: 'Fat content', titleZh: '脂肪含量', type: 'number', unit: '%', filterable: true, required: false, cardVisible: true, productVisible: true, categoryIds: ['cat-dairy'], sortOrder: 12 },
];
...
const dairy: PriceRow[] = [
  row('DA-001', 'cat-dairy', 'Сливочное масло Fin, 500 г', 95000, 'упаковка', 'pack', { weight: '500 г', product_type: 'сливочное масло', fat: 79 }, { brandName: 'Fin' }),
  ...
  row('DA-013', 'cat-dairy', 'Сыр Svalya, 3 кг', 390000, 'упаковка', 'pack', { weight: '3 кг', price_per_kg: 130000, product_type: 'сыр', fat: 45 }, { brandName: 'Svalya' }),
...
export const priceList2026Products: Product[] = priceRows.map((entry, index) => {
  ...
  return {
    ...
    descriptionZh: '此商品来自 SANPACK 当前价格目录。库存和配送条件请向经理确认。',
    ...
    variants: (entry.variants ?? []).map((variant) => ({
      ...
      titleZh: localizeSeedVariantLabel(variant.label, 'zh'),
      price: variant.price,
