...
export const priceList2026Categories: Category[] = [
  { id: 'cat-packaging', slug: 'upakovka', titleRu: 'Упаковка и расходные материалы', titleUz: 'Qadoqlash va sarf materiallari', titleEn: 'Packaging and consumables', image: '/catalog/categories/packaging_hero.png', icon: 'Package', status: 'active', sortOrder: 1 },
  { id: 'cat-trash-bags', parentId: 'cat-packaging', slug: 'musornye-pakety', titleRu: 'Мусорные пакеты', titleUz: 'Chiqindi paketlari', titleEn: 'Refuse bags', image: '/catalog/categories/trash_bags.png', icon: 'Trash2', status: 'active', sortOrder: 10 },
  { id: 'cat-tearoff-bags', parentId: 'cat-packaging', slug: 'otryvnye-pakety', titleRu: 'Отрывные пакеты', titleUz: 'Uziladigan paketlar', titleEn: 'Perforated bags', image: '/catalog/categories/tearoff_bags.png', icon: 'Layers', status: 'active', sortOrder: 11 },
  { id: 'cat-carrier-bags', parentId: 'cat-packaging', slug: 'pakety-mayka', titleRu: 'Пакеты «Майка»', titleUz: 'Mayka paketlar', titleEn: 'T-shirt carrier bags', image: '/catalog/categories/carrier_bags.png', icon: 'ShoppingBag', status: 'active', sortOrder: 12 },
  { id: 'cat-special-bags', parentId: 'cat-packaging', slug: 'vakuumnye-i-pizza-pakety', titleRu: 'Вакуумные пакеты и пакеты для пиццы', titleUz: 'Vakuum va pitsa paketlari', titleEn: 'Vacuum and pizza bags', image: '/catalog/categories/vacuum_pizza_bags.png', icon: 'PackageOpen', status: 'active', sortOrder: 13 },
  { id: 'cat-food-packaging', parentId: 'cat-packaging', slug: 'upakovka-dlya-produktov', titleRu: 'Упаковка для пищевых продуктов', titleUz: 'Oziq-ovqat qadoqlari', titleEn: 'Food packaging', image: '/catalog/categories/food_packaging.png', icon: 'Film', status: 'active', sortOrder: 14 },
  { id: 'cat-gloves', parentId: 'cat-packaging', slug: 'perchatki', titleRu: 'Перчатки', titleUz: 'Qo‘lqoplar', titleEn: 'Gloves', image: '/catalog/categories/gloves.png', icon: 'Hand', status: 'active', sortOrder: 15 },
  ...
  { id: 'cat-food', slug: 'produkty-pitaniya', titleRu: 'Продукты питания', titleUz: 'Oziq-ovqat mahsulotlari', titleEn: 'Food products', image: '/catalog/categories/food_hero.png', icon: 'Utensils', status: 'active', sortOrder: 2 },
  { id: 'cat-beef', parentId: 'cat-food', slug: 'govyadina', titleRu: 'Говядина', titleUz: 'Mol go‘shti', titleEn: 'Beef', image: '/catalog/categories/beef.png', icon: 'Beef', status: 'active', sortOrder: 20 },
  { id: 'cat-chicken', parentId: 'cat-food', slug: 'kuritsa', titleRu: 'Курица', titleUz: 'Tovuq go‘shti', titleEn: 'Chicken', image: '/catalog/categories/chicken.png', icon: 'Drumstick', status: 'active', sortOrder: 21 },
  ...
  { id: 'cat-groats', parentId: 'cat-food', slug: 'krupy-i-bobovye', titleRu: 'Крупы и бобовые', titleUz: 'Yorma va dukkaklilar', titleEn: 'Grains and pulses', image: '/catalog/categories/groats.png', icon: 'Wheat', status: 'active', sortOrder: 25 },
  ...
  { id: 'cat-fruits', parentId: 'cat-food', slug: 'frukty', titleRu: 'Фрукты', titleUz: 'Mevalar', titleEn: 'Fruit', image: '/catalog/categories/fruits.png', icon: 'Apple', status: 'active', sortOrder: 27 },
  ...
  { id: 'cat-vegetables', parentId: 'cat-food', slug: 'ovoshchi', titleRu: 'Овощи', titleUz: 'Sabzavotlar', titleEn: 'Vegetables', image: '/catalog/categories/vegetables.png', icon: 'Carrot', status: 'active', sortOrder: 29 },
  { id: 'cat-greens', parentId: 'cat-food', slug: 'svezhaya-zelen', titleRu: 'Свежая зелень Novagreen', titleUz: 'Novagreen yangi ko‘katlari', titleEn: 'Fresh Novagreen greens', image: '/catalog/categories/fresh_greens.png', icon: 'Leaf', status: 'active', sortOrder: 30 },
